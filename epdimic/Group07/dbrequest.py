...
from .models import DailyNewBj
from django.db.models import Avg,Max,Min,Count,Sum
from . import daily_new_form
from .daily_new_form import dailyform,deleteform
from .models import DailyTotalProvince
from .models import DailyNewProvince
from .models import DailyTotalNationwide
from .models import DailyNewNationwide
