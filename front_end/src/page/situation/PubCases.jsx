...
class PubCases extends React.Component {	
	state = {
		...
		//province : "BJ",
		//url : "/ESS/background/Cases?province=" + "BJ",
	}
	componentWillMount(){
		this.getStatistics();
		this.getRearEnd();
	...
	constructor(props){
		...
		ProvinceName = this.state.provinceData[provinceId][0]
		UrlProp = this.state.provinceData[provinceId][1]

		Url = "/ESS/background/Cases?province="+UrlProp
		//this.setState({
		//	url: url
		//})
	}
	...
	getDayToDel = values => {
		...
		let url_3 = "/ESS/background/Cases?province=" + UrlProp +"&date="+del_date;
